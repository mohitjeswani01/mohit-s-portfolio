...
const Footer: React.FC = () => {
  return (
    <footer className="py-12 px-4 bg-card/20 backdrop-blur-sm border-t border-border">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-muted-foreground">
              <p>Email: jeswanimohit959@gmail.com</p>
              <p>Phone: +91 72764 23350</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/20 transition-all duration-300"
              >
        ...
        <div className="pt-8 border-t border-border text-center text-muted-foreground">
          <p>&copy; 2024 Mohit Jeswani. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
